...
public class RawImageFadeManager : MonoBehaviour
{
    ...
    [HideInInspector] public bool FadeIninScript = false;
    [HideInInspector] public bool FadeOutinScript = false;
    ...
    public void FadeIn()
    {
        ...
        {
            fadeinRoutine = CharFadeIn(rawImage, FadeInTime, FadeInToAlpha);
    ...
    public void FadeOut()
    {
        ...
        {
            StartCoroutine(CharFadeOut(rawImage, FadeOutTime));
        }
    }

    private IEnumerator CharFadeIn(RawImage charSprite, float FadeInTime, float FadeInToAlpha)
    {
        FadeIninScript = true;
    ...
    private IEnumerator CharFadeOut(RawImage charSprite, float FadeOutTime)
    {
